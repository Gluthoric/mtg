      ...
      <div v-else>
        ...
        <div v-if="statistics" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div class="bg-card p-4 rounded-lg">
            ...
            <ul class="space-y-1">
              <li v-for="(count, effect) in statistics.frame_effects" :key="effect" class="flex justify-between">
                <span>{{ effect }}</span>
          ...
          <div class="bg-card p-4 rounded-lg">
            ...
            <ul class="space-y-1">
              <li v-for="(count, promo) in statistics.promo_types" :key="promo" class="flex justify-between">
                <span>{{ promo }}</span>
                <span class="font-semibold">{{ count }}</span>
              </li>
            </ul>
          ...
          <div class="bg-card p-4 rounded-lg">
            ...
            <ul class="space-y-1">
              <li v-for="(count, attribute) in statistics.other_attributes" :key="attribute" class="flex justify-between">
                <span>{{ attribute }}</span>
                <span class="font-semibold">{{ count }}</span>
              </li>
            </ul>
          ...
          >
            ...
            <div class="card-info p-2 flex flex-col">
              <div class="flex justify-between items-center mb-2">
                <p class="text-xs text-muted-foreground">CN: {{ card.collector_number }}</p>
              ...
              <div class="card-quantities flex flex-col space-y-2">
                ...
                <div class="quantity-control">
                  <label :for="'regular-' + card.id" class="quantity-label text-xs font-semibold text-muted-foreground block mb-1">
                    Regular
                  </label>
                ...
                <div class="quantity-control">
                  <label :for="'foil-' + card.id" class="quantity-label text-xs font-semibold text-muted-foreground block mb-1">
                    Foil
                  </label>
                  <div class="input-wrapper flex items-center justify-center border rounded-md overflow-hidden">
                    <button
            ...
            <div v-if="isMissing(card)" class="missing-indicator absolute top-1 right-1 bg-destructive text-destructive-foreground px-2 py-1 rounded text-xs font-bold shadow">
              Missing
            </div>
          </div>
        </div>
        ...
        <div v-if="cards.length === 0" class="text-center text-muted-foreground mt-4">
